...
$process = $_SESSION['process'];
  ...
  if (isset($_POST['signin'])) {
     ...
     //$process=$_POST['process'];
  	...
  	$update=mysqli_query($conn,"UPDATE `emp` SET `password` = '$pass' WHERE `emp`.`emp_id` = '$emp_id'");
...
<div class="login-box">
  	...
  	<div class="login-box-body">
    	<h4 class="login-box-msg">Set your new password</h4>

    	<form method="post" action="">
         
      		<div class="form-group has-feedback">
        		<input type="text" class="form-control input-lg" id="employee" name="password" placeholder="Enter new Passwoed" required>
